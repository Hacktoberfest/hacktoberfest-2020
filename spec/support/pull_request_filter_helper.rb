...
ARRAY_WITH_INVALID_DATES = [
   ...
   {"id"=>"MDExOlB1bGxSZXF1ZXN0NTE0MTg4ODg=",
    ...
    "body"=>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veni",
  ...
  def mock_pull_request_filter(array_type)
    if array_type == "valid array"
      VALID_ARRAY.select do |e|
        !e['labels'].include?('invalid') && e['createdAt'] >= ENV["START_DATE"] && e['createdAt'] >= ENV["END_DATE"]
      end
    ...
    elsif  array_type == "invalid dates and invalid label"
