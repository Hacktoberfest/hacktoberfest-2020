...
EARLY_RECEIPT_3_PRS = [{ 'github_pull_request' =>
      { 'graphql_hash' =>
     ...
     { 'github_pull_request' =>
       { 'graphql_hash' =>
         { 'id' => 'MDExOlB1bGxSZXF1ZXN0MzI1NDc4MDc2',
           ...
           'repository' => { 'databaseId' => 211_178_535 } } } }].freeze

EARLY_RECEIPT_2_PRS = [{ 'github_pull_request' =>
     { 'graphql_hash' =>
       { 'id' => 'MDExOlB1bGxSZXF1ZXN0MzI1NDc3OTA3',
         'url' => 'https://github.com/raise-dev/hacktoberfest-test/pull/18',
         'body' => '',
...
LATE_RECEIPT_2_PRS = [{ 'github_pull_request' =>
     { 'graphql_hash' =>
       { 'id' => 'MDExOlB1bGxSZXF1ZXN0MzI1NDc3OTA3',
         'url' => 'https://github.com/raise-dev/hacktoberfest-test/pull/18',
         'body' => '',
...
LATE_RECEIPT_3_PRS = [{ 'github_pull_request' =>
             { 'graphql_hash' =>
               { 'id' => 'MDExOlB1bGxSZXF1ZXN0MzI1NDc3OTA3',
                 'url' => 'https://github.com/raise-dev/hacktoberfest-test/pull/18',
                 'body' => '',
