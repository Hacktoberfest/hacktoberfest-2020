  ...
  describe '#update_all' do
    context 'Given an array of issues' do
      it 'calculates and saves the quality score for each issue' do
        ...
        allow(issue_quality_calculator)
          .to receive(:calculate_quality_progressively)
        ...
        expect(issue1.reload.quality).to eq issue_1_quality
        expect(issue2.reload.quality).to eq issue_2_quality
      end
    end
  end
end
