...
module ClimateProjectService
  ...
  PROJECTS = [
    ...
    },
    {
      ...
      language: 'JavaScript',
      description: 'Tools to understand and welcome people into a contributor \
                    community'
    },
    {
      name: 'polarmap.js',
      ...
      language: 'JavaScript',
      description: 'Custom Leaflet layer for re-projecting maps \
                    and map features'
    },
    {
      name: 'climate',
    ...
    },
    {
      ...
      language: 'CSS',
      description: 'Pledge your respect and appreciation for contributors \
